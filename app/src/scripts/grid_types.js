...
var GridTypes = {
    ...
    lab: {
        columns: [
            ...
            { column: 1, name: 'reportedDate', header: 'Reported Date', nowrap: true },
            { column: 2, name: 'runId', header: 'Run ID', nowrap: true }, 
            { column: 3, name: 'testCode', header: 'Panel' }, 
            { column: 4, name: 'accession', header: 'ACCN' },
            { column: 5, name: 'mrn', header: 'MRN', nowrap: true },
            { column: 6, name: 'surgpathId', header: 'Surgpath ID', nowrap: true },
            { column: 7, name: 'diagnosis', header: 'Diagnosis' }, 
            { column: 8, name: 'locus', header: 'Locus' },
            { column: 9, name: 'gene', header: 'Gene',
                hrefName: "gene", href: "https://www.genecards.org/cgi-bin/carddisp.pl?gene="
            },
